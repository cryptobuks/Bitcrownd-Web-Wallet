...
$dbusr = "root";   // database username
$dbpwd = "";   // database password
$dbtbl = "bit_data";   // database name
...
if(!$user_session) {
   ...
   $RPC_Port = "8332";              // port for bitcoin rpc
   $RPC_User = "user1324";     // username for bitcoin rpc
   $RPC_Pass = "pass1324";     // password for bitcoin rpc
